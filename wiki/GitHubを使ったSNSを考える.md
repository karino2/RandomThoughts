[技術的な事を話すweb上の場](技術的な事を話すweb上の場.md)の派生で、GitHubを使ってSNS作れないかなぁ、と考えて見たがうまく行かなかったので、メモの残骸を残しておく。
...
少し違うが、[一人で使うタイムライン的な何かが欲しい](一人で使うタイムライン的な何かが欲しい.md)の結果、[てきすとTL](てきすとTL.md)というのを作った。これはこのページで考えた事の派生形ではある気がする（SNSでは無いが）。