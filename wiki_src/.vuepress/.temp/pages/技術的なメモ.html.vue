...
<li><a href="https://bvckup2.com/" target="_blank" rel="noopener noreferrer">Bvckup 2 - Simple fast backup</a> バックアップソフト。出来が良いらしい。</li>
<li><a href="https://www.canva.com/ja_jp/" target="_blank" rel="noopener noreferrer">Canva：無料デザインツール：プレゼンテーション、動画、SNSなどをデザインして作成できます</a></li>
<li><a href="https://www.slideshare.net/rawwell/hyper-estraier-presentation" target="_blank" rel="noopener noreferrer">Hyper Estraierの設計と実装</a>
<ul>
<li><a href="https://github.com/ztittle/Qdbm.Net" target="_blank" rel="noopener noreferrer">ztittle/Qdbm.Net: .NET port of the QDBM Embedded Database</a> qdbmのdotnet移植があるじゃん。</li>
</ul>
</li>
<li><a href="https://github.com/spectreconsole/radline" target="_blank" rel="noopener noreferrer">spectreconsole/radline: A .NET library to read and display keyboard input.</a> dotnetでrepl作るのに良さそう。</li>
<li><a href="https://aws.amazon.com/jp/sagemaker/studio-lab/" target="_blank" rel="noopener noreferrer">機械学習のための無料開発環境 - JupyterLab - Amazon Web Services</a> Colabが有料になるとの事なので</li>
<li><a href="https://github.com/jlevy/the-art-of-command-line" target="_blank" rel="noopener noreferrer">jlevy/the-art-of-command-line: Master the command line, in one page</a></li>
<li><a href="https://dev.realworldocaml.org/toc.html" target="_blank" rel="noopener noreferrer">Real World OCaml</a></li>
<li><a href="https://www.elsevier.com/books/programming-massively-parallel-processors/hwu/978-0-323-91231-0" target="_blank" rel="noopener noreferrer">Programming Massively Parallel Processors - 4th Edition</a>　omo先生が読んでたCUDAの本。</li>
<li><a href="https://third-bit.com/sdxjs/introduction/" target="_blank" rel="noopener noreferrer">Software Design by Example: Introduction</a> JSのlesson系コンテンツ</li>
<li><a href="https://postmarketos.org/" target="_blank" rel="noopener noreferrer">postmarketOS // real Linux distribution for phones</a> Androidデバイス上で素のLinuxみたいなの動かす奴</li>
<li><a href="https://toffeeshare.com/" target="_blank" rel="noopener noreferrer">Share files privately, fast and without size limit using ToffeeShare</a> ブラウザ上でデバイス間のファイル共有</li>
<li><a href="https://blog.kyanny.me/entry/2024/09/13/160600" target="_blank" rel="noopener noreferrer">Bruno the API client - @kyanny's blog</a> GUIのAPIクライアント</li>
<li><a href="https://restic.net/" target="_blank" rel="noopener noreferrer">restic · Backups done right!</a> バックアップツール、いいかもしれん。</li>
<li><a href="https://doc.veryl-lang.org/book/ja/01_introduction.html" target="_blank" rel="noopener noreferrer">概要 - The Veryl Hardware Description Language</a> Pezy社で次世代Verilog的なのを作っているらしい。いいね。</li>
</ul>
</div></template>
