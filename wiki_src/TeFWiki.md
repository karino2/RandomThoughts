...
[[Electron]]版とAndroid版があって、[[Syncthing]]でデータを共有して使っている。サーバー要らず。
...
[[RandomThoughts]]のバックリンクサポートがいい感じだったので、TeFWikiのElectron版もバックリンクをサポートしてみた。

Android版も欲しいけれど[[SAF]]は遅いので使い物になるか自信が無かったので必要になるまでやらない。
