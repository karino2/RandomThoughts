...
その結果を[[guash]]で出力先を選べるようにしてもいいが、まずは固定ファイルから。

[[htmnix]]は適当なhtml片を食わせるとUIを表示してユーザーに選ばせて、選んだ結果を標準出力に出す、というものになっている。
これとElectron版てきすとTLのmainのコードを切り貼りすればそれっぽいものが出来るんじゃないか。