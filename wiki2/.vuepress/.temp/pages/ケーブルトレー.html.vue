<template><div><h1 id="ケーブルトレー" tabindex="-1"><a class="header-anchor" href="#ケーブルトレー"><span>ケーブルトレー</span></a></h1>
<p>机の下につけて、電源タップを置いたりするものをケーブルトレーと呼ぶらしい。</p>
...
<p>おお、これはまさに俺に必要なものなのでは？と思いポチる。</p>
<h2 id="_2022-07-25-机が厚すぎてつけれない" tabindex="-1"><a class="header-anchor" href="#_2022-07-25-机が厚すぎてつけれない"><span>2022-07-25 机が厚すぎてつけれない！</span></a></h2>
<p>うおっ！机の厚みがありすぎて、クランクがつけられない！まじかー。
このケーブルトレーが駄目というよりは机の構造がケーブルトレー向きじゃない構造だった。
うーん、先に確認しておけば、ちょっとこれつけられないでは？と思って厚さ測っただろうが。うかつだった。</p>
<p>とりあえずダンボールに挟んでダンボールを机の上に伸ばす事で、机の下に設置する事は出来た。
机の上に段差が出来て不愉快で、こんなはずでは無かった、という気分ではあるが、
実用上は別段普通につけても変わらない状態ではあるので、
しばらくこれで使い心地を評価していこう。</p>
</div></template>
