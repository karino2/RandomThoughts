<template><div><h1 id="食事関連" tabindex="-1"><a class="header-anchor" href="#食事関連"><span>食事関連</span></a></h1>
<ul>
...
玄米ごはん 160g×12袋</a></p>
<p>36袋で3980円。ポイントが265ポイントつくのでほぼ1袋100円で、まぁ許容範囲か。
...
イソマルトデキストリン無しでも食物繊維は下記の発芽玄米より豊富なので、こちらの方がいいかも。</p>
<p>味は発芽玄米とあまり変わらず。
もっと玄米の味が強い方が好みなのだけれど、手軽に買えるメリットを思えばこれでいいかな。</p>
<p>以後これをメインにした。</p>
...
<p>発芽玄米は以下の：
<a href="https://hb.afl.rakuten.co.jp/ichiba/3e90b021.5028c8fa.3e90b022.be83f001/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fyamatane%2F10000078%2F&link_type=pict&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJwaWN0Iiwic2l6ZSI6IjI0MHgyNDAiLCJuYW0iOjEsIm5hbXAiOiJyaWdodCIsImNvbSI6MSwiY29tcCI6ImRvd24iLCJwcmljZSI6MSwiYm9yIjoxLCJjb2wiOjEsImJidG4iOjEsInByb2QiOjAsImFtcCI6ZmFsc2V9" target="_blank" rel="nofollow sponsored noopener" style="word-wrap:break-word;"><img src="https://hbb.afl.rakuten.co.jp/hgb/3e90b021.5028c8fa.3e90b022.be83f001/?me_id=1308289&item_id=10000078&pc=https%3A%2F%2Fthumbnail.image.rakuten.co.jp%2F%400_mall%2Fyamatane%2Fcabinet%2F04875641%2F06750788%2F10000078_240307_thum.jpg%3F_ex%3D240x240&s=240x240&t=pict" border="0" style="margin:2px" alt="" title=""><br>レトルト発芽玄米ごはん</a></p>
<p>玄米でいいんだけど、パック玄米はゴミが多いのと箱で手軽に買いづらいので、レトルト発芽玄米に。
コレステロール下げる効果がどちらが大きいかは良くわからないのだが、食物繊維量は大差無いのでどちらでもいいのかな、と思っている。
効果が少なければ玄米に変更してもいいかも。</p>
<p>LDLコレステロールを下げるというと青魚ということだが、
サバやいわしの缶詰は続かなかったので、いわしの魚肉ソーセージで妥協した。
これなら割と食べられるし、ヨドバシでまとめ買い出来るので買うのも手軽。
ただしいわし以外も結構入ってそうなので、どこまで効果があるかは不明。</p>
<p>脂肪ゼロヨーグルトは下げるというよりは上げない間食として。
乳脂肪はあまり健康には良くないという話は聞いていたが、LDLコレステロールという点では脂肪ゼロヨーグルトは問題無いそうで、
LDLコレステロールよりも優先度が高い項目はなかろう、ということで脂肪ゼロヨーグルトを間食に食べるようにした。</p>
<p>納豆は効果があるらしいとのことで多少混ぜているが、たまに程度。それほど効くとも思えないので気休め程度で。</p>
<p>海藻類を足すために、昼と夜に味付け海苔をつけてみることにした。これも気休め程度だが、食物繊維は配食サービスなどでそれなりに取れていると思うので、
プラスアルファくらいで。</p>
<p>個人的には下がるという食事をするよりも、上がるような食事を避けるのと量を食べすぎない方が重要だと思っているのだけれど、
最近は体重も割と低めでキープ出来ていてそちらは問題無いので、プラスアルファとして下げる効果のありそうなものをいろいろとってみている。
前回の健康診断でもそれなりに下がっていてあと一歩くらいまでの所には来ていたので、来年の健康診断まで効果のありそうなものをいろいろとってみることにしている。</p>
<h2 id="自分の食事差分-2024-08-12" tabindex="-1"><a class="header-anchor" href="#自分の食事差分-2024-08-12"><span>自分の食事差分 (2024-08-12)</span></a></h2>
<p>間食はプロテインバーをやめて、</p>
<ul>
<li>いわし魚肉ソーセージ（ヨドバシ）</li>
<li>無脂肪ヨーグルト</li>
<li>バナナ</li>
</ul>
<p>あたりをなんとなく食べる形にした。上２つはLDLコレステロール値対策として。
LDLコレステロール対策として青魚を食べようとしているが、缶詰はなかなかうまく食べられないため魚肉ソーセージで妥協してみている、という感じ。
いわし魚肉ソーセージは全部いわしという訳では無いのでどの程度効果があるかは未定だが、
手軽に続けられるので次の健康診断まで続けて効果を見てみよう、と思っている。</p>
<p>無脂肪ヨーグルトは、以前はヨーグルトなどの乳製品は動物性脂肪として良く無いと思って避けていたが、
...
<p>ここは他にもいろいろ試している所で、ポップコーン、玄麦カンパン、炒り大豆なども食べているが、食物繊維比率と食べすぎないのが容易なフルーツグラノーラハンディタイプがいいんじゃないかと結論づけつつある。
この辺は基本的にはヨドで買って試している。</p>
<p>夕飯以降もたまに間食するが、最近は夕飯以降はなるべく取らないように頑張っている。
取る時もだらだら食べずに一回だけ、上記と同じような内容の間食を取る。</p>
<p>夕飯以降は何か食べたくなったら飴をなめて我慢している。</p>
<h3 id="追加で摂るもの" tabindex="-1"><a class="header-anchor" href="#追加で摂るもの"><span>追加で摂るもの</span></a></h3>
<p>筋トレなどのあとにはプロテインゼリーを摂る。
ここはそんなに激しくしている訳では無いので気休め程度。
プロテイン量としては森永のinゼリーの奴が15gで一番多くて今試しているが、
カロリーも高いのでRIZAPの奴でいいかなぁ、とも思っている。</p>
<p>サーフィンやウィンドサーフィンなどの激しく時間も長い運動をしたあとは追加でいろいろ食べたりしている。
炭水化物を足すべくパック玄米ごはんを食べたり、プロテインゼリーを飲んだり。
この辺は決定版がなくて、回復が遅くなったり頭痛になって寝込んだりする事もあるので改善したい所。
あと、太陽が出ている時にやった場合は塩分補給タブレットを摂るようになった。頭痛にはこれが効いているかも？</p>
<h3 id="飲み物" tabindex="-1"><a class="header-anchor" href="#飲み物"><span>飲み物</span></a></h3>
<p>基本はコーヒーと水。喉が乾いた時とか食事の時とかは水が基本でそれ以外はコーヒーが基本。
15時以降はカフェインは取らないようにしていて、水か白湯かココアを飲んでいる。
ただそんな厳密にしている訳じゃないので、カフェで読書する時に夕方コーヒー飲んだりはしている。
あまりそれで寝れないとかいう事も無いので、別に気にしなくてもいい気もしている。</p>
<p>ココアは甘くない奴をお湯でといてる。あんま溶けないし、そんな美味しくないが、そのくらいでちょうどいいかもしれない、と思ってまぁまぁ気に入っている。</p>
...
8袋なら送料も無料なので悪くない。（6980円以上は送料無料、と書いてあるが、その下に送料無料、と書いてあるように4000円くらいでも送料無料になっている。謎）</p>
<p><a href="https://hb.afl.rakuten.co.jp/ichiba/2b6c1e25.d64fbf59.2b6c1e26.394f416f/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fkitchen-garden%2F10004984%2F&link_type=pict&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJwaWN0Iiwic2l6ZSI6IjI0MHgyNDAiLCJuYW0iOjEsIm5hbXAiOiJyaWdodCIsImNvbSI6MSwiY29tcCI6ImRvd24iLCJwcmljZSI6MCwiYm9yIjoxLCJjb2wiOjEsImJidG4iOjEsInByb2QiOjAsImFtcCI6ZmFsc2V9" target="_blank" rel="nofollow sponsored noopener" style="word-wrap:break-word;"  ><img src="https://hbb.afl.rakuten.co.jp/hgb/2b6c1e25.d64fbf59.2b6c1e26.394f416f/?me_id=1221616&item_id=10004984&pc=https%3A%2F%2Fthumbnail.image.rakuten.co.jp%2F%400_mall%2Fkitchen-garden%2Fcabinet%2Fitem_fix%2Fimgrc0079422028.jpg%3F_ex%3D240x240&s=240x240&t=pict" border="0" style="margin:2px" alt="" title=""><br>
カントリーファーム　フルーツミューズリー　８袋セット
</a></p>
<p>以前はフルーツナッツミューズリを食べていたが、さすがに硬派過ぎて辛くなってきたのと、たまに固いのが混じっていてガリってなって不安になるので、フルーツミューズリに変えた。
一見ほとんど同じに見えるが食べてみると結構違ってて、
フルーツミューズリの方がドライフルーツが多くてそのおかげで少し甘い。
このくらいなら割と美味しく食べられる。</p>
</div></template>
