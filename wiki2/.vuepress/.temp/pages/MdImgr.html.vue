<template><div><h1 id="mdimgr" tabindex="-1"><a class="header-anchor" href="#mdimgr"><span>MdImgr</span></a></h1>
<p>md用の画像管理ソフトが欲しい。
...
<p><a href="./【書籍】魔法の人物ドローイング.html">【書籍】魔法の人物ドローイング</a>に描いた絵を貼れるようになった。画像のディレクトリも自分が考えた名前に出来て管理しやすく、いい感じだ。</p>
