<template><div><h1 id="powershell" tabindex="-1"><a class="header-anchor" href="#powershell"><span>PowerShell</span></a></h1>
<p><a href="./Windows.html">Windows</a>のシェル。<a href="./技術的なメモ.html">技術的なメモ</a></p>
