<template><div><h1 id="サーフボード" tabindex="-1"><a class="header-anchor" href="#サーフボード"><span>サーフボード</span></a></h1>
<ul>
...
ギュインと曲げるのでは無くまーるく乗る。</p>
<p><a href="https://www.youtube.com/watch?v=x8Bw_VHkPeM" target="_blank" rel="noopener noreferrer">Luvsurf TV 363：PLACEBO『LAYZ POTATO』西井浩治 「コウジ・ニシイ」Koji Nishii - YouTube</a></p>
<p>このボードのもう少し短いのに乗ってみたい気はしている。</p>
<h2 id="ニューフライヤー-new-flayer" tabindex="-1"><a class="header-anchor" href="#ニューフライヤー-new-flayer"><span>ニューフライヤー（New Flayer）</span></a></h2>
<p>5'11の29.8l（たぶん）。自分のメインボード。
なんか私のは日本版でググって出てくる色付きの奴とはちょっと違う（全部黒）。</p>
<p>腰以上の波なら一番調子いい。コントロールがしやすく、でもちょっとパワーゾーンを外れてもそこまでは失速しない。
自分の実力でもちょうど楽しく乗れる。
でもモモ以下でたるい時はちょっときつい。</p>
<p>クイックに上げられているが、もうちょっと短くてもいいかなぁ、とは思っている。
このボードの5'9〜5'10くらいがベストボードなんじゃないかと思っているが、どうかなぁ。</p>
<p>なおでかい波の時にも十分な長さがあるので、乗れないのは長さのせいじゃないと納得出来て良い。</p>
</div></template>
