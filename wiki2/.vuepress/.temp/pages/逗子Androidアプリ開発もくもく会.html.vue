<template><div><h1 id="逗子androidアプリ開発もくもく会" tabindex="-1"><a class="header-anchor" href="#逗子androidアプリ開発もくもく会"><span>逗子Androidアプリ開発もくもく会</span></a></h1>
...
<h2 id="日時、場所" tabindex="-1"><a class="header-anchor" href="#日時、場所"><span>日時、場所</span></a></h2>
<ul>
<li>毎週木湯 17:00〜21:00</li>
...
<p>時間的に夕飯にかぶるが夕飯は無い。終わったあとの懇親会とかも無い。
ただ疲れてきた時とかに途中で雑談になったりはする。</p>
<h2 id="交流センターの説明" tabindex="-1"><a class="header-anchor" href="#交流センターの説明"><span>交流センターの説明</span></a></h2>
<p>電源とWiFiはある（ただ自分はWiFiは使った事無い）。延長ケーブルは頼めば貸してくれる。
